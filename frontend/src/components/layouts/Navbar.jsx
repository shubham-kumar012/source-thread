...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 bg-[#272727]/90 backdrop-blur-md shadow-md rounded-lg px-6 py-4">
            <div className="flex justify-between items-center max-w-7xl mx-auto">
                ...
                <div className="md:hidden text-[#E2E2E2] text-2xl cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
            ...
            {/* Mobile Menu */}
            {isOpen && (
                <ul className="md:hidden flex flex-col items-center space-y-4 mt-4 text-[#E2E2E2] font-medium bg-[#272727]/95 rounded-lg py-6">
                    {menuItems.map((item, index) => (
                        <li key={index} className="relative group cursor-pointer">
                            <span className="hover:text-orange-500 transition-colors duration-300">
                                {item}
